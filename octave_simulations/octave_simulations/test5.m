% going ahead, we now have to be practical. so, the first sensor receiving
% the signal is considered as reference, and accordingly, a new trailiteration
% equation is formulated to estimate target location. all other things remain
% same.
